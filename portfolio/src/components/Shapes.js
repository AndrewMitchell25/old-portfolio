...
export default function Shapes(){
    return(
        <div className="shapes">
            ...
            <Circle className="circle white1" speed={8} size="30" style={{transform: 'translateX(50vw)', top: '70vh'}}/>
            <Circle className="circle blue1" speed={-12} size="250" style={{transform: 'translateX(20vw)', top: '100vh'}}/>
